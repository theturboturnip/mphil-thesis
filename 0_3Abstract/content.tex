...
Arm SVE\cite{stephensARMScalableVector2017} and RISC-V V\cite{specification-RVV-v1.0} (a.k.a. RVV) are new flagship vector extensions for Arm and RISC-V, which use a ``vector-length agnostic programming model'' to allow hardware implementations to choose their vector lengths.
