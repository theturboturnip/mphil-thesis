...
A new CHERI-specific vector register file was created, where each register is a \code{SafeTaggedCap} (page \pageref{safetaggedcap}) i.e. either zero-tagged integer data or a valid tagged capability.
