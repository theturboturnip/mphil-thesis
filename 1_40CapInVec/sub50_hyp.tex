...
\subsection{Testing and evaluation: \code{vector\_memcpy\_pointers}}\label{chap:capinvec:eval}
We constructed a second test program to ensure \code{vector\_memcpy} could be performed correctly with capabilities-in-vectors.
