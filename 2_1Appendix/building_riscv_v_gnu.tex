...
I have archived the branch in my own repository (\redact{\gitrepo{theturboturnip/riscv-gnu-toolchain}{https://github.com/theturboturnip/riscv-gnu-toolchain}}) and fixed that issue.
