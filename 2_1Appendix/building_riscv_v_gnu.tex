...
\begin{enumerate}
    ...
    \item Change the \code{.gitmodules} file to point the \code{"riscv-glibc"} submodule at the upstream \code{glibc} repository \url{https://sourceware.org/git/?p=glibc.git}, which hosts the RISC-V version as of 19 March 2021\todocite{https://github.com/riscvarchive/riscv-glibc/tree/archive-notify}.
