...
\begin{enumerate}
    ...
    \item Switch to the \code{rvv-intrinsic} branch.
    \item Change the \code{.gitmodules} file to point the \code{riscv-glibc} submodule at the upstream \code{glibc} repository \url{git://sourceware.org/git/?p=glibc.git}, which hosts the RISC-V version as of 19 March 2021\footnote{Stated in \gitrepo[archive-notify]{riscvarchive/riscv-glibc}{https://github.com/riscvarchive/riscv-glibc/tree/archive-notify}}.
