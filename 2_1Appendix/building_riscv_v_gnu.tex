...
As of May 2022, the RISC-V GNU toolchain (currently located at \eurl{https://github.com/riscv-collab/riscv-gnu-toolchain/}) does not support the vector extension or it's intrinsics.
...
\begin{enumerate}
    ...
    \item Change the \code{.gitmodules} file to point the \code{"riscv-glibc"} submodule at the upstream \code{glibc} repository \eurl{https://sourceware.org/git/?p=glibc.git}, which hosts the RISC-V version as of 19 March 2021\todocite{https://github.com/riscvarchive/riscv-glibc/tree/archive-notify}.
    
    \todomark{Example}
    \begin{itemize}
        \item Alternatively, this can be pointed at \eurl{https://github.com/riscvarchive/riscv-glibc.git}, the archived version of the old repository\todocite{maxOS GCC instructions}.
    \end{itemize}
