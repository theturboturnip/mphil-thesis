...
GCC is an interesting case --- there is a version based on RISC-V GCC 10.1 that partially supports RVV (see \cref{chap:eval:subsec:compilerdifferences}), but it was left untouched for a year and deleted as of 17th May 2022.
