...
\begin{table}[b]
    ...
    \midrule
        \newhyp{}\label{hyp:sw_vec_legacy}  &
            Vector code can be compiled in legacy forms (with integer addressing) and still function correctly on CHERI. \\
        \newhyp{}\label{hyp:sw_pure_compat} &
            Vector code can be compiled into a pure-capability form from a legacy form with no source code changes. \\
        \newhyp{}\label{hyp:sw_multiproc} &
    ...
    \midrule
        ...
        \newhyp{}\label{hyp:cap_in_vec_manip} &
