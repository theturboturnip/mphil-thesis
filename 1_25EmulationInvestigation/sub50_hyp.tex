...
Arm SVE has other addressing modes like \code{u64base}, which uses a vector as a set of 64-bit addresses\cite{armltdArmCompilerScalable2019}, which require more specific attention.
