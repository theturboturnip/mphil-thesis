...
The above work is available online\footnote{\gitrepo{theturboturnip/cheri-compressed-cap}{https://github.com/theturboturnip/cheri-compressed-cap}}, and includes documentation for all C functions (which is not documented in the main repository).
That documentation is also available online\footnote{\url{https://theturboturnip.github.io/files/doc/rust_cheri_compressed_cap/}} and partially reproduced in \cref{appx:docs:rustcherilib}.
